...
const ORIGINS = [
...

  {
    ...
    buff: "智商 +50",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "研究員", relation: 70, age: 40, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "教授", relation: 75, age: 38, gender: "female" },
      // ✅ 新增
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "退休院士", relation: 60, age: 75, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "首席圖書館員", relation: 70, age: 72, gender: "female" },
    ],
  },

  {
    ...
    buff: "魅力自然高",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "影帝", relation: 60, age: 45, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "歌后", relation: 65, age: 42, gender: "female" },
      // ✅ 新增
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "傳奇製片", relation: 55, age: 78, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "秀場天后", relation: 80, age: 75, gender: "female" },
    ],
  },

  {
    ...
    buff: "智商高，愛讀書",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "大學教授", relation: 85, age: 48, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "圖書館長", relation: 90, age: 46, gender: "female" },
      // ✅ 新增
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "國學大師", relation: 90, age: 80, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "書法家", relation: 85, age: 78, gender: "female" },
    ],
  },

  {
    ...
    buff: "健康 +20",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "將軍", relation: 70, age: 50, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "軍醫", relation: 80, age: 45, gender: "female" },
      // ✅ 新增
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "退伍老兵", relation: 85, age: 82, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "軍眷會長", relation: 75, age: 78, gender: "female" },
    ],
  },

  {
    ...
    buff: "醫學技能 +30",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "主任醫師", relation: 75, age: 48, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "護理師", relation: 85, age: 44, gender: "female" },
      // ✅ 新增
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "老中醫", relation: 80, age: 80, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "藥劑主任", relation: 85, age: 76, gender: "female" },
    ],
  },
  ...
  // ===== 困難出身 =====
  {
    ...
    buff: "健康 +15，快樂 +5",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "果農", relation: 90, age: 45, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "菜農", relation: 95, age: 43, gender: "female" },
      // ✅ 新增
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "產銷班長", relation: 85, age: 75, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "傳統灶腳", relation: 95, age: 72, gender: "female" },
    ],
  },

  {
    ...
    buff: "健康 +10",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "漁民", relation: 85, age: 46, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "漁民", relation: 90, age: 44, gender: "female" },
      // ✅ 新增
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "老船長", relation: 80, age: 74, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "補網師", relation: 90, age: 70, gender: "female" },
    ],
  },

  {
    ...
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "頭目", relation: 90, age: 45, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "織布師", relation: 95, age: 42, gender: "female" },
      // ✅ 新增
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "部落長老", relation: 100, age: 78, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "靈媒", relation: 90, age: 75, gender: "female" },
    ],
  },

  {
    ...
    buff: "溝通 +20",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "移工", relation: 90, age: 40, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "移工", relation: 95, age: 38, gender: "female" },
      // ✅ 新增 (設定為一同居住的長輩)
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "家鄉長老", relation: 80, age: 70, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "傳統手藝人", relation: 90, age: 68, gender: "female" },
    ],
  },

  {
    ...
    buff: "堅強獨立",
    initNPCs: [
      { id: "mom", name: "媽媽", type: "parent", role: "單親媽媽", relation: 100, age: 35, gender: "female" },
      // ✅ 新增 (外公外婆幫忙帶)
      { id: "grandpa", name: "外公", type: "grandparent", role: "退休警衛", relation: 90, age: 68, gender: "male" },
      { id: "grandma", name: "外婆", type: "grandparent", role: "慈祥老人", relation: 100, age: 65, gender: "female" },
    ],
  },
  ...
  // ===== 特殊出身 =====
  {
    ...
    buff: "程式 +30",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "PM", relation: 70, age: 40, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "工程師", relation: 80, age: 38, gender: "female" },
      // ✅ 新增
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "無線電玩家", relation: 60, age: 72, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "數學老師", relation: 70, age: 68, gender: "female" },
    ],
  },

  {
    ...
    buff: "藝術 +40，魅力 +10",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "畫家", relation: 85, age: 45, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "音樂家", relation: 85, age: 42, gender: "female" },
      // ✅ 新增
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "雕刻家", relation: 80, age: 78, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "聲樂家", relation: 85, age: 75, gender: "female" },
    ],
  },

  {
    ...
    buff: "溝通 +25",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "立委", relation: 60, age: 50, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "市長", relation: 65, age: 48, gender: "female" },
      // ✅ 新增
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "黨大老", relation: 50, age: 80, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "婦女會長", relation: 70, age: 76, gender: "female" },
    ],
  },

  {
    ...
    buff: "堅韌不拔 +30",
    initNPCs: [
      { id: "director", name: "院長奶奶", type: "mentor", role: "院長", relation: 80, age: 65, gender: "female" },
      // ✅ 新增 (模擬長輩角色)
      { id: "janitor", name: "校工伯伯", type: "mentor", role: "工友", relation: 85, age: 60, gender: "male" },
      { id: "cook", name: "煮飯阿姨", type: "mentor", role: "廚師", relation: 90, age: 55, gender: "female" },
    ],
  },

  {
    ...
    buff: "溝通 +15",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "廟祝", relation: 80, age: 50, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "乩童", relation: 85, age: 48, gender: "female" },
      // ✅ 新增
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "解籤人", relation: 90, age: 75, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "誦經團長", relation: 95, age: 72, gender: "female" },
    ],
  },

  {
    ...
    buff: "魅力 +20，健康 +15",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "堂主", relation: 75, age: 50, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "大姐頭", relation: 80, age: 45, gender: "female" },
      { id: "bodyguard", name: "保鑣阿強", type: "subordinate", role: "貼身保鑣", relation: 90, age: 30, gender: "male" },
      // ✅ 新增
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "創幫元老", relation: 60, age: 80, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "壓寨夫人", relation: 90, age: 76, gender: "female" },
    ],
  },
  ...
  // ===== 頂級特殊出身 =====
  {
    ...
    special: "royal",
    initNPCs: [
      { id: "dad", name: "父王", type: "parent", role: "國王", relation: 60, age: 55, gender: "male" },
      { id: "mom", name: "母后", type: "parent", role: "王后", relation: 70, age: 50, gender: "female" },
      // ✅ 新增
      { id: "grandpa", name: "皇爺爺", type: "grandparent", role: "太上皇", relation: 50, age: 82, gender: "male" },
      { id: "grandma", name: "皇奶奶", type: "grandparent", role: "皇太后", relation: 85, age: 78, gender: "female" },
      { id: "butler", name: "管家阿爾弗雷德", type: "servant", role: "忠誠管家", relation: 100, age: 60, gender: "male" },
    ],
  },

  {
    ...
    special: "hacker",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "白帽駭客", relation: 70, age: 45, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "資安專家", relation: 75, age: 42, gender: "female" },
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "電腦怪傑", relation: 60, age: 75, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "密碼學家", relation: 70, age: 72, gender: "female" },
      { id: "mentor", name: "駭客導師 Ghost", type: "mentor", role: "技術導師", relation: 85, age: 35, gender: "male" },
    ],
  },

  {
    ...
    special: "detective",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "名偵探", relation: 75, age: 48, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "犯罪心理學家", relation: 80, age: 45, gender: "female" },
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "傳奇警探", relation: 50, age: 78, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "推理小說家", relation: 85, age: 75, gender: "female" },
      { id: "partner", name: "搭檔老王", type: "partner", role: "最佳拍檔", relation: 90, age: 40, gender: "male" },
    ],
  },

  {
    ...
    special: "chef",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "米其林主廚", relation: 75, age: 50, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "甜點師", relation: 85, age: 45, gender: "female" },
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "國宴主廚", relation: 60, age: 80, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "醬料達人", relation: 90, age: 76, gender: "female" },
      { id: "sous_chef", name: "副主廚老李", type: "colleague", role: "廚房夥伴", relation: 80, age: 35, gender: "male" },
    ],
  },

  {
    ...
    special: "monk",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "住持", relation: 85, age: 55, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "法師", relation: 90, age: 50, gender: "female" },
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "老方丈", relation: 95, age: 85, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "虔誠居士", relation: 90, age: 82, gender: "female" },
      { id: "master", name: "師父玄空", type: "master", role: "授業恩師", relation: 95, age: 70, gender: "male" },
    ],
  },

  {
    ...
    special: "circus",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "團長", relation: 80, age: 45, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "空中飛人", relation: 85, age: 40, gender: "female" },
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "魔術大師", relation: 70, age: 72, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "占卜師", relation: 65, age: 70, gender: "female" },
    ],
  },

  {
    ...
    special: "diplomat",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "大使", relation: 65, age: 50, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "外交官", relation: 70, age: 48, gender: "female" },
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "前外交部長", relation: 50, age: 78, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "禮儀專家", relation: 80, age: 75, gender: "female" },
    ],
  },

  {
    ...
    special: "esports",
    initNPCs:[
      { id: "dad", name: "爸爸", type: "parent", role: "電競教練", relation: 80, age: 40, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "職業選手", relation: 85, age: 38, gender: "female" },
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "街機廳老闆", relation: 90, age: 68, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "俄羅斯方塊高手", relation: 85, age: 65, gender: "female" },
      { id: "coach", name: "戰隊教練", type: "coach", role: "魔鬼教練", relation: 70, age: 35, gender: "male" },
    ],
  },

  {
    ...
    special: "spy",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "特務", relation: 60, age: 45, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "情報員", relation: 65, age: 42, gender: "female" },
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "前情報局長", relation: 40, age: 75, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "解碼專家", relation: 80, age: 72, gender: "female" },
      { id: "handler", name: "接頭人 Mr. Smith", type: "contact", role: "神秘接頭人", relation: 50, age: 50, gender: "male" },
    ],
  },

  {
    ...
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "考古學家", relation: 80, age: 50, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "博物館長", relation: 85, age: 48, gender: "female" },
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "老館長", relation: 70, age: 80, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "古物修復師", relation: 90, age: 78, gender: "female" },
    ],
  },

  {
    ...
    special: "fashion",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "時裝設計師", relation: 70, age: 45, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "超模", relation: 75, age: 40, gender: "female" },
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "傳奇裁縫", relation: 60, age: 75, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "時尚教母", relation: 80, age: 70, gender: "female" },
      { id: "stylist", name: "御用造型師", type: "stylist", role: "造型師", relation: 80, age: 30, gender: "female" },
    ],
  },

  {
    ...
    special: "scientist",
    initNPCs: [
      { id: "dad", name: "爸爸", type: "parent", role: "諾貝爾獎得主", relation: 75, age: 55, gender: "male" },
      { id: "mom", name: "媽媽", type: "parent", role: "研究員", relation: 80, age: 50, gender: "female" },
      { id: "grandpa", name: "爺爺", type: "grandparent", role: "物理學泰斗", relation: 60, age: 85, gender: "male" },
      { id: "grandma", name: "奶奶", type: "grandparent", role: "數學家", relation: 70, age: 82, gender: "female" },
      { id: "assistant", name: "實驗助理", type: "assistant", role: "研究助理", relation: 75, age: 25, gender: "male" },
    ],
  },
];
const LIFE_STAGES = [
